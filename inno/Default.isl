; *** Inno Setup version 3.0.2+ English messages ***
;
...
;
; $Id: Default.isl,v 1.12 2002/06/02 20:27:37 martijn Exp $
...
SelectDirLabel=Select the folder where you would like [name] to be installed, then click Next.
...
BadDirName32=Directory names cannot include any of the following characters:%n%n%1
DirExistsTitle=Directory Exists
DirExists=The directory:%n%n%1%n%nalready exists. Would you like to install to that directory anyway?
DirDoesntExistTitle=Directory Does Not Exist
DirDoesntExist=The directory:%n%n%1%n%ndoes not exist. Would you like the directory to be created?
...
WizardFinished=Setup Completed
